...
#include "custom_msgs/msg/detail/estimator_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_msgs::msg::DataXYZ &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_msgs::msg::DataXYZ &);
size_t get_serialized_size(
  const custom_msgs::msg::DataXYZ &,
  size_t current_alignment);
size_t
max_serialized_size_DataXYZ(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const custom_msgs::msg::EstimatorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::EstimatorData & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
max_serialized_size_EstimatorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::EstimatorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::EstimatorData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EstimatorData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::EstimatorData *>(
...
static size_t _EstimatorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EstimatorData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EstimatorData__callbacks = {
  "custom_msgs::msg",
  "EstimatorData",
...
static rosidl_message_type_support_t _EstimatorData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EstimatorData__callbacks,
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_EstimatorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, EstimatorData)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_EstimatorData__handle;
}
