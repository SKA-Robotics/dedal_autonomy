...
static rosidl_typesupport_introspection_c__MessageMember custom_msgs__msg__EstimatorData__rosidl_typesupport_introspection_c__EstimatorData_message_member_array[6] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs__msg__EstimatorData, speed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs__msg__EstimatorData, accel),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, EstimatorData)() {
  ...
  custom_msgs__msg__EstimatorData__rosidl_typesupport_introspection_c__EstimatorData_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, DataXYZ)();
