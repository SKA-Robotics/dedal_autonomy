...
custom_msgs__msg__AccelData__create()
{
  ...
  memset(msg, 0, sizeof(custom_msgs__msg__AccelData));
  bool success = custom_msgs__msg__AccelData__init(msg);
  if (!success) {
...
custom_msgs__msg__AccelData__destroy(custom_msgs__msg__AccelData * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    custom_msgs__msg__AccelData__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
custom_msgs__msg__AccelData__Sequence__init(custom_msgs__msg__AccelData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_msgs__msg__AccelData * data = NULL;

  if (size) {
    data = (custom_msgs__msg__AccelData *)allocator.zero_allocate(size, sizeof(custom_msgs__msg__AccelData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_msgs__msg__AccelData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_msgs__msg__AccelData__fini(&data[i - 1]);
      }
...
custom_msgs__msg__AccelData__Sequence__fini(custom_msgs__msg__AccelData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_msgs__msg__AccelData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_msgs__msg__AccelData__Sequence * array = (custom_msgs__msg__AccelData__Sequence *)allocator.allocate(sizeof(custom_msgs__msg__AccelData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_msgs__msg__AccelData__Sequence__init(array, size);
  if (!success) {
...
custom_msgs__msg__AccelData__Sequence__destroy(custom_msgs__msg__AccelData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_msgs__msg__AccelData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_msgs__msg__AccelData__Sequence__are_equal(const custom_msgs__msg__AccelData__Sequence * lhs, const custom_msgs__msg__AccelData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_msgs__msg__AccelData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_msgs__msg__AccelData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_msgs__msg__AccelData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_msgs__msg__AccelData * data =
      (custom_msgs__msg__AccelData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_msgs__msg__AccelData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_msgs__msg__AccelData__fini(&output->data[i]);
        }
        return false;
      }
    }
