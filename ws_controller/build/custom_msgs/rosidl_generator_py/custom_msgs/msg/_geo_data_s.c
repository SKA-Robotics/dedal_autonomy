...
bool custom_msgs__msg__geo_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._geo_data.GeoData", full_classname_dest, 33) == 0);
  }
  custom_msgs__msg__GeoData * ros_message = _ros_message;
  {  // latitude
...
{
  /* NOTE(esteve): Call constructor of GeoData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._geo_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GeoData");
